 ...
 * @version 1.0
*/
public class StudentGroup implements Iterable<Student>, Comparable<StudentGroup>, Externalizable {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        out.writeObject(this.getGroup());
        out.writeInt(this.getIdGroup());
    }

    @Override
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        this.setGroup((List<Student>)in.readObject());
        this.setIdGroup(in.readInt());
    }
}
