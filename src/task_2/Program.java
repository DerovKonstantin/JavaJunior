...
public class Program {
    ...
    */
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        Employee user = new Employee("Stanislav", "sample@gmail.com"); // создаем пользователя
        QueryBuilder queryBuilder = new QueryBuilder(); // передаем в класс обработки запросов
